...
if (isset($_POST['btDathang'])) {
    ...
    $sqli = "insert into orders(firstname, lastname	, address, phone, email, status, created_at, updated_at) values ('$firstname', '$lastname', '$address', '$phone', '$email', 'Processing', now(), now())";
    // echo $sqli;
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="checkout__input">
                            ...
                            <input type="text" required placeholder="Địa chỉ" class="checkout__input__add" name="address">
                        </div>
